//! Configuration types for venues.
//!
//! These types are designed to be deserialized from TOML configuration files
//! and used by both data and execution venues.

use serde::{Deserialize, Serialize};
use std::time::Duration;

/// Base configuration for any venue.
...
mod tests {
    ...
    fn test_auth_config() {
        let config =
            AuthConfig::new("TEST_API_KEY", "TEST_API_SECRET").with_passphrase("TEST_PASSPHRASE");
